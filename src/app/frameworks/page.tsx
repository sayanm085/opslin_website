...
import { RuntimeSelector } from "@/components/site/runtime-selector";
...
export default function FrameworksPage() {
  return <ResourcePage>
    ...
    <ResourceSection eyebrow="Interactive compatibility explorer" title="Select a runtime to see its real configuration boundary." description="Official-color marks identify ecosystems. The descriptions stay conservative and are based on the current deployment surface."><RuntimeSelector /></ResourceSection>
