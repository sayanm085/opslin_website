...
export default function StatusPage() {
  return <ResourcePage>
    ...
    <section className="site-section site-section-tinted"><div className="site-container"><div className="telemetry-disconnected" role="img" aria-label="Disconnected public telemetry illustration"><span><Activity /></span><i/><span><CircleDashed /></span><strong>Public telemetry source not connected</strong><small>No uptime or incident values are fabricated.</small></div></div></section>
